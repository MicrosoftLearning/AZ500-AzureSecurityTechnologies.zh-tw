...
![顯示本實驗室中任務流程的圖表。](../media/azure-firewall-diagram.png)
...
3. 在 [建立防火牆 **] **刀鋒視窗的 [**基本]** 索引標籤上，指定下列設定： 
...
3. 在 [Srv-Work **] **刀鋒視窗上，按一下 [**網路]。**

4. 在 [**Srv-Work \| 網路設定]** 刀鋒視窗上，按一下 [網路介面 **] **專案旁的連結。
...
3. 在 [Srv-Jump] **刀鋒視窗上，按一下 [連線 **]，然後**在**下拉式功能表中按一下 [連線**]。** 

4. 下載 RDP 檔案，並使用它透過遠端桌面連線到 **Srv-Jump** Azure VM。 出現驗證提示時，請提供下列認證：
