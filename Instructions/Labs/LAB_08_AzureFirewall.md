...
5. 在 [路由表] 刀鋒視窗中按一下 [重新整理]，然後在路由表清單中點選 [Firewall-route] 項目。

6. 在 [Firewall-route] 刀鋒視窗的 [設定] 區段按一下 [子網路]，然後在 [Firewall-route \| 子網路] 刀鋒視窗中按一下 [+ 關聯]。
...
9. 返回 [Firewall-route] 刀鋒視窗，在[設定] 區段中按一下 [路由]，然後點選 [+ 新增]。 
