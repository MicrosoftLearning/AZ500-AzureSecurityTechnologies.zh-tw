...
ms.locfileid: "145195861"
---
# <a name="az-500-microsoft-azure-security-technologies"></a>AZ-500：Microsoft Azure 安全性技術

- **[實驗室連結 (HTML 格式)](https://microsoftlearning.github.io/AZ500-AzureSecurityTechnologies/)**
...
- 所有 MCT 都可以向 GitHub 存放庫中的程式碼或內容提交提取要求。 Microsoft 和課程作者會視需要進行分級，並納入內容和實驗室程式碼變更。
